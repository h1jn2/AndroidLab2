...
class Test4_1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // actionbar 에 들어가는 내용이 개발자 뷰인 toolbar 에 그대로 적용
        setSupportActionBar(binding.toolbar)

        // 지정한 문자열은 화면 출력과 상관없고 내부저긍로 상태를 표시하는 문자열
    ...
    // 메뉴 이벤트 처리 함수
    // toggle 이 낸부적으로는 메뉴이고 toggle 클릭 시에 메뉴 이벤트 함수 호출
    // 메뉴 이벤트 처리가 실행되지 않고 toggle 에 준비됨
    // drawer 제어 이벤트 처리가 되도록 해줘야 함
