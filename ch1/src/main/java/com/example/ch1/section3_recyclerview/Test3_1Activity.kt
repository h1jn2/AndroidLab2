...
//        val layoutManager = GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, true)
        // gridlayout, horizontal, false
//        val layoutManager = GridLayoutManager(this, 2, GridLayoutManager.HORIZONTAL, false)
        // staggered
//        list.add("aaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaa aaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaa aaaaaaaaa")
//        list.add("bbbbbbbbbbb bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb")
//        list.add("ccccccccccc")
//        list.add("dddddddddddddd ddddddddddddddddddddddddddd dddddddddddddddddddddd ddddddddddddddddddddd dddddddddddd")
...
class MyDecoration(val context: Context): RecyclerView.ItemDecoration() {
    // 항목이 찍히기 전에 최초 한번, 바탕 드로잉이 필요할 때
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        // 이미지를 recyclerview 의 center 위치에 그리고 싶을 때 좌표 계산
        // 뷰의 크기 계산
        ...
        // 이미지가 center 에 그려지게 left, top 좌표 계산
    ...
    // 항목 하나당 한번씩 호출, 항목에 추가 꾸미기 작업이 필요힐 때
    override fun getItemOffsets(
        outRect: Rect,  // 항목이 출력되는 사각형 정보
        view: View,     // 항목이 출력되는 뷰 객체
        parent: RecyclerView,
