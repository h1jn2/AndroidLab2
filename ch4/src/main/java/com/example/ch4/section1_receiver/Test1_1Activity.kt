package com.example.ch4.section1_receiver
...
class Test1_1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 특정 상황, 특정 컴포넌트가 실행 중인 상태에서만 실행되어야 하는 경우
    ...
    override fun onDestroy() {
        super.onDestroy()
        // 코드에서 동적 등록시킨 리시버는 어느 순간 실행될 필요가 없다는 의미
        // 동적 등록 해제
        // 액티비티, 서비스 등은 onCreate() 에서 등록하고 onDestroy() 에서 해제
