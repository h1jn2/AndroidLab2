...
class Test2_1Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url =
            "https://newsapi.org/v2/everything?q=travel&apiKey=c26836668b0d487190ad5498725a7298&page=1&pageSize=5"
        val queue = Volley.newRequestQueue(this)
        val request = object : JsonObjectRequest(
            Method.GET,
            url,
            null,
            Response.Listener<JSONObject> {     // 성공 시 callback
            ...
            Response.ErrorListener {            // error 시 callback
                Log.d("kkang", "$it")
            }
        ) {
            // header 설정
